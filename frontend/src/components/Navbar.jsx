        ...
        <div className='flex items-center gap-4'>
            {
                ...
                <div className='flex items-center gap-2 cursor-pointer group relative'>
                    <img className="w-8 rounded-full"src={userdata.image} alt="profile_picture" />
                    ...
                    <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                        <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                            ...
                            <p onClick={logoutfun} className='hover:text-black cursor-pointer'>Logout</p>
                        </div>
                    </div>
                </div>
                :
                <button onClick={()=>navigate("/login")} className="bg-indigo-500 text-white px-8 py-3 rounded-full font-medium hidden md:block cursor-pointer">Create account</button>
